...
public class CouchBaseStorage implements Storage {
  ...
  public List<Map> search(
    ...
    try {
      QueryResult result =
          cluster.query(
              builder.toString(), QueryOptions.queryOptions().parameters(namedParameters));
  ...
  public long count(SearchCriteria searchCriteria) {
    ...
    JsonObject namedParameters = composeNamedParameters(searchCriteria);
    QueryResult result =
        cluster.query(builder.toString(), QueryOptions.queryOptions().parameters(namedParameters));
