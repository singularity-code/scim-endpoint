...
public class MemoryStorage implements Storage {
  ...
  public List<Map> search(
    ...
    if (searchCriteria == null
        ...
        || searchCriteria.getCriteria().size() == 0) {
  ...
  private void initializeUniqueConstraints(String type) {
    String uniqueConstraintsString =
        propertyFactory.getProperty("scim.storage.memory." + type.toLowerCase() + ".unique");
  ...
  private void checkConstraints(String id, Map<String, Object> object)
      throws ConstraintViolationException {
  ...
  public synchronized void flush() {
    ...
    if (flush) {
      ...
      try {
        ...
        logger.debug(
            "{} saved in {} ms", f.getAbsolutePath(), (System.currentTimeMillis() - start));
      } catch (IOException e) {
