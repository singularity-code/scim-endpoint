...
> java -jar -Dserver.port=8080 personify-scim-server-1.4.0.RELEASE.jar
...
>docker run -p 8080:8080 -e scim.storage.implementation=... -e scim.storage.mongo.database=users personify/personify-scim-server:1.4.0.RELEASE
...
>java -jar -Dserver.port=8080 personify-scim-server-1.4.0.RELEASE.jar -Dscim.schema.location=/tmp/disc_schema_custom.json
